...
const RankingView: React.FC<RankingViewProps> = ({ profiles, currentProfileId }) => {
              ...
              return (
                <div 
                  ...
                  className={`flex items-center justify-between p-6 transition-colors ${
                    isMe ? 'bg-indigo-50/50 dark:bg-indigo-900/20' : 'hover:bg-gray-50 dark:hover:bg-gray-900/40'
                  }`}
                >
