    ...
    return (
        <div className="p-4 md:p-10 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 pb-32">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl md:text-4xl font-black font-outfit text-gray-800 dark:text-white">Painel Administrativo</h1>
                    <p className="text-gray-500 dark:text-gray-400">Gerenciamento Geral</p>
                </div>
                <div className="flex items-center gap-4">
                    <div className="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-xl">
                        <button
                            onClick={() => setActiveTab('USERS')}
                            className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'USERS' ? 'bg-white dark:bg-gray-700 shadow-sm text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Usuários
                        </button>
                        <button
                            onClick={() => setActiveTab('SHOP')}
                            className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'SHOP' ? 'bg-white dark:bg-gray-700 shadow-sm text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Loja
                        </button>
                    </div>
